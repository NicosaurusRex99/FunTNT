...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        this.tag(BlockTags.MINEABLE_WITH_HOE).add(ModBlocks.BABY_BOOMER.get()).add(ModBlocks.FERTILIZER.get()).add(ModBlocks.CRYO.get()).add(ModBlocks.GRAVITY.get()).add(ModBlocks.RESTORATION.get());
        ...
        this.tag(tnt).add(ModBlocks.BABY_BOOMER.get()).add(ModBlocks.NUKE.get()).add(ModBlocks.FERTILIZER.get()).add(ModBlocks.GRAVITY.get()).add(ModBlocks.TRIP_MINE.get()).add(ModBlocks.RESTORATION.get());
    }
}