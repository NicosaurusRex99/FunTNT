...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LatelyEntity>> LATELY = ENTITIES.register("lately", () -> EntityType.Builder.<LatelyEntity>of(LatelyEntity::new, MobCategory.MISC).sized(0.98F, 0.98F).clientTrackingRange(64).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(FunTNT.MODID, "lately"))));
